						...
						<div class="card" id="bar-fixed">
							<div class="add-wrap list-type5"  style="padding:30px;width:100%;">
								...
								<ul class="kt-nav" id="add-field" role="tablist">
									<li class="kt-nav__item field ui-sortable-handle">
    ...
    $.getJSON('includes/atividade/sjfb-load-form?form_id=' + formID, function(data) {
        ...
        function addFieldHTML(fieldType) {
            ...
            switch (fieldType) {
                ...
                case 'signature_box':
                    return '' +
                        '<div id="sjfb-signature_box-' + uniqueID +'" class="sjfb-field sjfb-signature_box required-field" style="background: #1ea59a;color: #fff;">' +
                        '<label class="block-title" style="padding: 5px;"></label>' +
                        '</div>';
                case 'agree':
                    return '' +
