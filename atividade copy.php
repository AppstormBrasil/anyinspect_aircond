                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-xl-4 ">
                                        <div class="invoice-info-right" style="text-align:right;">
                                                <div class="mb-4">
                                                <span id="foto_cliente"><img  style="width:50px;height:50px;float:right;" class="avatar_table" src="assets/images/noimage.png" alt=""> </span>
                                                    <h4 id="nome_cliente" class="text-primarys mb-2"  ></h4>
                                                    <a id="email_cliente"  class="text-muted"></a>
                                                </div>
                                                <div  style="margin-top:20px;" class="mb-4">
                                ...
                                <div class="row">
                                    ...
                                    <div id="box_sig_col" style="width: 100%;">
                                        ...
                                        <div id="box_action_sigcolab" class="col-lg-12" style="text-align: right;padding-right: 20px;margin-bottom: 15px;">
                                            <button  class="btn-xs btn btn-primary" id="save_sig1">Confirmar Assinatura</button>
                                            <button style="background: #9E9E9E;color: #fff;" class="no_print btn btn-xs" id="clear_sig1">Limpar</button>
                                        </div>
                                    </div>
                                    ...
                                    <div id="box_sig_cli" style="width: 100%;">
                                        ...
                                        <div id="box_action_sigcli" class="col-lg-12" style="text-align: right;padding-right: 20px;margin-bottom: 15px;">
                                            <button class="btn-xs btn btn-primary" id="save_sigcli">Confirmar Assinatura</button>
                                            <button style="background: #9E9E9E;color: #fff;" class="no_print btn btn-xs" id="clear_sig1cli" >Limpar</button>
                                        </div>
                                    </div>
                    ...
                    <div class="modal-body">
                        <div class="row clearfix">
                            <div class="col-lg-12 col-md-12">
                                ...
                                <form class="form novo_equipamento_form" id="validate_form_imagem" role="form" >
                                    <div class="cards">
                                        <div class="body">
                                            <div class="row clearfix">
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <!--<a style="width:100%;color:#fff;" class="no-print btn btn-brand btn-elevate" onclick="saveImageRemote(canvas);"  value="submit">Salvar</a>-->
                                                    <button id="clearBtn" class="btn btn-default" >Limpar</button>
                                                    <button id="saveBtn2" class="btn btn-success" >Salvar</button>
                                                    <!--<button style="display:none;" id="sendBtn2" class="btn btn-primary" >Enviar</button>-->
    ...
    <script>
        ...
        function get_info_gerais(){
            ...
            data:{
                ...
                $("#foto_empresa").html('<img  style="width:50px;height:50px;float: left;" class="avatar_table" src="'+foto_empresa+'" alt="">');
                ...
                $("#foto_cliente").html('<img  style="width:50px;height:50px;float:right;" class="avatar_table" src="'+foto_cliente+'" alt="">');
...
function call_img(id){
    ...
    $(".remove_img").click(function(){ 
        var id = this.id;
        $("#image_form_"+id+"").attr("src", 'images/noimage.jpg');
        $('.img_file_'+id+'').val(""); 
        $("#badge_save_"+id+"").hide();
            ...
            if(status == 'SUCCESS'){
                ...
                if(comments != null){
                    ...
                    for(var a = 0; a < comments.length; a++){
                        comments_target = comments[a].target;
                        comments_val = comments[a].target_value;
                        $('#'+comments_target).val(comments_val);
                    }
                }
