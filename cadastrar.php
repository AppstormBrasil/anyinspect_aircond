...
<body class="h-100">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="logo text-center">
                                    <a href="index.html">
                                        <img src="assets/images/f-logos.png" alt="">
                                    </a>
                                </div>
                                <h4 class="text-center mt-4">Cadastrar</h4>
                                <form class="mt-5 mb-5">
									...
									<div class="form-group">
                                        ...
                                        <input type="password2" class="form-control" placeholder="Password2">
                                    </div>
                                    <div class="form-row">
    ...
    <script src="includes/controller/agenda/cadastrar_condominio.js"></script>
</body>
