(function ($, moment)
{
   ...
   function Plugin(element, options)
   {
      ...
      this.params = {date: true, time: true, format: 'YYYY-MM-DD', minDate: null, maxDate: null, currentDate: null, lang: 'pt', weekStart: 0, disabledDays: [], shortTime: false, clearButton: false, nowButton: false, cancelText: 'Cancelar', okText: 'Ok', clearText: 'Limpar', nowText: 'Agora', switchOnClick: false, triggerEvent: 'focus', monthPicker: false, year:true};
