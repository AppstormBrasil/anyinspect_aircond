...
<body>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-xxl-12">
                        <div class="card">
                            <div class="card-body file-uploading-widget">
                                <div class="row">
                                    
                                    <div class="col-xl-4 col-xxl-4 col-md-4">
                                        <h4 class="card-title mb-5">Meta do dia <span id="data_hoje"></span> </h4> 
                                        <div class="text-center">
                                            <canvas id="gauge-1"></canvas>
                                        </div>
                                        <div class="text-center upload-details pb-5">
                                            <h2  id="current_percent" >75%</h2>
                                            <h4 class="mb-5">Atividades realizadas</h4>
                                    ...
                                    <h4 class="card-title mb-5">Plano de Ação <span id="data_hoje"></span> </h4> 
                                        <ul class="music-list">
                                            <li>
                                                <div class="media align-items-center">
                                                    <img class="mr-4" src="assets/images/icons/59.png" alt="image">
                                                    <div class="media-body">
                                                        <h4 class="mb-1">Something just like this..mp3</h4>
                                                        <span class="text-primary font-small">By B.S.Druid Wensleydale</span>
                                                    </div>
                                            ...
                                            <li>
                                                <div class="media align-items-center">
                                                    <img class="mr-4" src="assets/images/icons/60.png" alt="">
                                                    <div class="media-body">
                                                        <h4 class="mb-1">Something just like this..mp3</h4>
                                                        <span class="text-primary font-small">By B.S.Druid Wensleydale</span>
                                                    </div>
                                            ...
                                            <li>
                                                <div class="media align-items-center">
                                                    <img class="mr-4" src="assets/images/icons/61.png" alt="">
                                                    <div class="media-body">
                                                        <h4 class="mb-1">Something just like this..mp3</h4>
                                                        <span class="text-primary font-small">By B.S.Druid Wensleydale</span>
                                                    </div>
                                        ...
                                        <div class="progress mb-2">
                                            <div class="progress-bar" style="width: 60%; height:10px;" role="progressbar"><span class="sr-only">60% Complete</span>
                                            </div>
                                        </div>
                                        <p class="text-center font-medium">Space Available 25 GB</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-12 col-lg-12 col-xxl-12">
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-12 col-xxl-4">
                                <div class="card widget-music-category">
                                    <div class="card-body">
                                        <h2 class="text-gray mb-4" id="servicos_pendentes">0</h2>
                                        <h4>Pendentes</h4>
                                        <p class="font-x-small mb-0">Pendentes</p>
                                    </div>
                                    <div class="doctor-list pt-4" id="box_pendentes" style="background: #f3f6f9;" >
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4 col-12 col-xxl-4">
                                <div class="card widget-music-category">
                                    <div class="card-body">
                                        <h2 class="text-warning mb-4" id="servicos_em_andamento">0</h2>
                                        <h4>Em Andamento</h4>
                                        <p class="font-x-small mb-0">Em Andamento</p>
                                    </div>
                                    <div class="doctor-list pt-4" id="box_andamento" style="background: #f3f6f9;">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4 col-12 col-xxl-4">
                                <div class="card widget-music-category">
                                    <div class="card-body">
                                        <h2 class="text-success mb-4" id="servicos_finalizados">0</h2>
                                        <h4>Concluído</h4>
                                        <p class="font-x-small mb-0">Concluído</p>
                                    </div>
                                    <div class="doctor-list pt-4" id="box_finalizado" style="background: #f3f6f9;">
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card">
                            <div class="card-header pb-0">
                                <h4 class="card-title m-t-10">Plano de Ação</h4>
                                <div class="table-action float-right">
                                    <form action="#">
                                        <div class="form-row">
                                            <div class="form-group m-0">
                                                <select id="inputState" class="form-control bg-transparent border-0 p-0">
                                                    <option selected="selected">90 Days</option>
                            ...
                            <div class="card-body pt-3">
                                <div class="row">
                                    <div class="col-lg-7 col-xxl-6 mb-xl-4 col-sm-6">
                                        <div class="row">
                                            <div class="col-xl-6">
                                                <div class="chart">
                                            ...
                                            <div class="col-xl-6 align-items-center d-flex mt-4 mt-lg-0">
                                                <ul class="revenue-chart-list d-flex d-xl-block">
                                                    <li class="ml-3 ml-xl-0"><i class="fa fa-music text-danger"></i> Classical</li>
                                                    <li class="ml-3 ml-xl-0"><i class="fa fa-music text-success"></i> Fusion</li>
                                                    <li class="ml-3 ml-xl-0"><i class="fa fa-music text-info"></i> Rock</li>
                                                    <li class="ml-3 ml-xl-0"><i class="fa fa-music text-warning"></i> Uncategorized</li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-5 col-xxl-6 col-sm-6 border-left">
                                        <ul class="track-list pl-4">
                                            <li>
                                                <div class="media">
                                                    <div class="track-icon mr-4">
                                                        <span class="bg-warning">01</span>
                                                    </div>
                                                    <div class="media-body">
                                                        <h4>Something just like this...</h4>
                                                        <p class="font-small"> <span class="text-muted">By </span>  <span class="text-primary">B.S.Druid Wensleydale</span>
                                                        </p>
                                                    </div>
                                                </div>
                                            </li>
                        ...
                        <div class="card">
                            <div class="card-header pb-4 justify-content-between align-items-center d-sm-flex views-chart-area">
                                <h4 class="card-title">Views</h4>
                                <div class="item d-sm-flex">
                                    <ul class="list d-sm-flex mt-3">
                                        <li class="mr-5"><span class="pr-3 circle-classical"><i class="fa fa-dot-circle-o"></i></span>Classical</li>
                                        <li class="mr-5"><span class="pr-3 circle-fusion"><i class="fa fa-dot-circle-o"></i></span>Fusion</li>
                                        <li class="mr-5"><span class="pr-3 circle-rock"><i class="fa fa-dot-circle-o"></i></span>Rock</li>
                                        <li class="mr-5"><span class="pr-3 circle-uncategorized"><i class="fa fa-dot-circle-o"></i></span>Uncategorized</li>
                                    </ul>
                                    <div class="item d-flex align-items-center">
                                        <div class="form-group border mb-0 ml-2">
                                            <!-- <div class="drop-menu" tabindex="1">
                                                <div class="select text-dark"><span>By Genre</span>  <i class="fa fa-caret-down"></i>
                                                </div>
                                            ...
                                            <select name="sort" class="selectpicker show-tick" data-width="auto" id="sort">
                            ...
                            <div class="card-body pt-3">
                                <div class="chart">
                                    <canvas id="chart-views-display"></canvas>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    ***********************************-->
    ...
    <script src="assets/plugins/gaugeJS/dist/gauge.min.js"></script>
    <!--<script src="includes/dashboard/dash_1.js"></script>-->
    <!--<script src="js/dashboard/dashboard-17.js"></script>-->
        ...
        method:"GET",
            success:function(response){
                ...
                if(status == "SUCCESS"){
                    ...
                    console.log(servicos_pendentes_hoje)
                    
                    $('#data_hoje').html(data_hoje);
...
function get_open_service(){
	...
	$.ajax({
     ...
     data:{id:idCliente},
		...
		var realizados = response.per;

        $('#current_percent').html(realizados+'%');
        get_valores();
        ...
        var opts = {
            ...
            colorStart: '#1ea59a',   // Colors
            colorStop: '#1ea59a',    // just experiment with them
            strokeColor: '#F3F6F9',  // to see which ones work best for you
            generateGradient: true,
            highDpiSupport: true,     // High resolution support
            percentColors : [[0.0, "#ff0000" ], [0.85, "#f9c802"], [1.0, "#1ea59a"]]
        };
        ...
        gauge.set(realizados); // set actual value

        
        var lista_bolt , lista_pets = "";
        var status_type = "";
        var box_pendentes = ""; 
        var box_andamento = "";
        var box_finalizado = "";
	  ...
	  if(status == "SUCCESS") {
        ...
        for(var a = 0; a < lista_atividades.length; a++){
            ...
            if(status_ == 'Em Andamento'){
                    box_andamento += '<div class="media bg-white" style="padding: 1rem 1rem;">'+
                        '<img style="width: 45px;height:45px;" class="mr-3 rounded-circle" alt="image" src="'+foto_ativo+'">'+
                        '<div class="media-body">'+
                            '<h5 class="mt-2 text-pale-sky">'+ativo+'</h5>'+
                            '<h6 class="text-primary mb-0">'+br_start+'</h6>'+
                            '<p><img style="width:20px;height:20px;" class="mr-3 rounded-circle" src="'+foto_funcionario+'" ></p>'+
                        '</div>'+
                        '<p class="text-muted mt-4 font-small"><a style="cursor:pointer;" class="start_servico" name="'+id+'" ><span style="background:'+color+';color:'+textColor+'" class="label label label-rounded ">'+status_+'</a></p><br>'+
                    '</div>'
            }
            
            if(status_ == 'Pendente'){
                    box_pendentes += '<div class="media bg-white" style="padding: 1rem 1rem;">'+
                        '<img style="width: 45px;height:45px;" class="mr-3 rounded-circle" alt="image" src="'+foto_ativo+'">'+
                        '<div class="media-body">'+
                            '<h5 class="mt-2 text-pale-sky">'+ativo+'</h5>'+
                            '<h6 class="text-primary mb-0">'+br_start+'</h6>'+
            ...
            if(status_ == 'Finalizado'){
                    box_finalizado += '<div class="media bg-white" style="padding: 1rem 1rem;">'+
                        '<img style="width: 45px;height:45px;" class="mr-3 rounded-circle" alt="image" src="'+foto_ativo+'">'+
                        '<div class="media-body">'+
                            '<h5 class="mt-2 text-pale-sky">'+ativo+'</h5>'+
                            '<h6 class="text-primary mb-0">'+br_start+'</h6>'+
      		...
      		$('#box_pendentes').html(box_pendentes);
      		$('#box_andamento').html(box_andamento);
      		$('#box_finalizado').html(box_finalizado);
