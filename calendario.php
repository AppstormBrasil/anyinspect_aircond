	 ...
	 <div class="modal-content">
		 ...
		 <div class="modal-body">
			...
			<div class="row">
				...
				<div class="col-lg-12">
					<div style="display:none;" id="ativo_box">

						<div class="form-group">
							<label class="text-label">Ativo / Equipamento <div class="form-check mb-2 mr-5">
				...
				<div style="display:none;width:100%" id="date_time_box">
					...
					<div class="col-lg-6 col-md-6" style="float: left;">
						...
						<ul id="extra_date" class="extra_date "></ul>
					</div>
				</div>
			</div>
	...
	$('#lista_funcionario_filtro').on('select2:unselecting', function (e) {
		...
		function get_list_service(id_team){
			...
			function servicesearch(data) {
				...
				if (data.id == 'none') {
					return 'Nenhuma Atividade atribuído <a target="_blank" style="float: right;" class="single_link btn btn-primary btn-sm" href="funcionario-'+id_team +'" >Atribuir Atividade</a>';
				} else {
