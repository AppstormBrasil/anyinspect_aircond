                    ...
                    <div class="col-lg-12 col-md-12">
                        ...
                        <form class="form novo_equipamento_form" id="validate_form_imagem" role="form" style="width: 100%;">
                            <div class="cards">
                                <div class="body">
                                    <div class="row clearfix">
                                        <div style="text-align:center;margin: auto;" class="js-signatures" data-width="500" data-height="500"  data-line-color="#bc0000" data-auto-fit="false"></div>
                                        <div class="col-md-12">
    ...
    <script>
        ...
        function get_info_gerais(){
            ...
            data:{
                ...
                $("#foto_empresa").html('<img  style="width:50px;float: left;" class="avatar_logo" src="'+foto_empresa+'" alt="">');
    ...
    $.getJSON('includes/atividade/sjfb-load-form?form_id=' + formID, function(data) {
        ...
        if (data) {
                            ...
                            if (fieldType == 'select') {
                                ...
                                var choiceHTML = '<div class="col-12">'+
                                                        '<div class="form-check mb-5 mr-5">'+
                                                            '<input class="form-check-input styled-checkbox" styled-checkbox" '+enable_disable+' id="ch_'+i+'" type="checkbox" name="checkbox-sjfb-' + uniqueID + '-'+i+'[]"' + selected + ' value="' + v['label'] + '" >'+
            ...
            call_lista_atividades(id_form,id_atividade);
                ...
                $('.save_check_list').on('click', function (e) {
                    ...
                    var elementsArray = document.getElementsByClassName("js-signature");
                    //console.log(elementsArray)

                    $(".js-signature").each( function() {
                        //console.log($(this)) ;
                        var id = $(this);
                        id = id[0].id;
                        ...
                        value = $('.'+id+'').jqSignature('getDataURL');

                        var title = id;
                        var value = value;
                        output_signature.push({name : title,value: value});

                        //console.log(value)

                        //value.value = [value.value];
                        //output_signature.push(value);
                    });

                    console.log(output_signature)
                   ...
                   //console.log(teste)
                    ...
                    var data2 = JSON.stringify(output_signature);
        ...
        function addFieldHTML(fieldType) {
            ...
            switch (fieldType) {
                ...
                case 'section':
                    return '' +
                        '<div id="sjfb-section-' + uniqueID +'" class="sjfb-field sjfb-section required-field" style="background:#f3f3f3;color:#333;margin-bottom: 0px;">' +
                        '<label class="block-title" style="padding: 5px;"></label>' +
                        '</div>'
                
				case 'signature_box':
                    return '' +
                        '<div id="sjfb-' + uniqueID +'-'+k+'" class="sjfb-field sjfb-signature_box required-field" >' +
                        '<div id="js-signature-' + uniqueID +'-'+k+'" class="js-signature js-signature-' + uniqueID +'-'+k+'"></div>'+
                        '<i style="font-size: 23px;float: left;" class="mdi mdi-pen"></i><label class="block-title" style="padding: 5px;width:90%;font-weight: 500;"></label>' +
                        '<a style="background: #9E9E9E;color: #fff;" class="no-print btn btn-xs clear_sig" id="' + uniqueID +'-'+k+'" >Limpar</a>'+
                        '</div>'
                case 'agree':
                    return '' +
...
$(".clear_sig").click(function(e){ 
    e.preventDefault();
    var id = this.id;
    $('.js-signature-'+id+'').jqSignature('clearCanvas');
});
