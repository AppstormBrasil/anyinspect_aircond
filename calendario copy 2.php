...
.fc-nonbusiness {
	background-image: linear-gradient(45deg, #dbdbdb 5%, #a8a8a8 5%, #a8a8a8 50%, #dbdbdb 50%, #dbdbdb 55%, #a8a8a8 55%, #a8a8a8 100%);
				...
				<div class="col-lg-6">
					<div style="display:none;" id="preco_div">
						<div class="form-group">
							...
							<div class="input-group">
								<input type="text" style="width: 100%;height: 45px;border:1px solid #dddfe1;padding-left:5px;font-weight: 800;font-size: 15px;" id="preco" name="preco" required></input>
							</div>
						</div>
