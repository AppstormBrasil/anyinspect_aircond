...
class PhpExcelReader {
     ...
     *  set mb if you would like use 'utf8_encode' for encode UTF-16LE to your encoding
     *
    ...
    public function setUTFEncoder($encoder = 'iconv')
    {
        ...
        if ($encoder == 'iconv') {
            ...
            $this->_encoderFunction = function_exists('utf8_encode') ?
                                      'utf8_encode' :
                                      '';
        }
    }
        ...
        if ($this->_defaultEncoding){
            switch ($this->_encoderFunction){
                case 'iconv' :     $result = iconv('UTF-16LE', $this->_defaultEncoding, $string);
                                break;
                case 'utf8_encode' :     $result = utf8_encode($string, $this->_defaultEncoding, 'UTF-16LE' );
                                break;
            }
        }
        return $result;
