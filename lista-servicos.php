        ...
        <div class="col-xl-12" >
            <div class="card m-b-0">
                <div class="card-header" style="padding:15px;">
                    ...
                    <a class="single_link float-right btn btn-primary" href="#cadastro-servico" ><span>Novo Serviço</span></a>
                </div>
...
var table = $('#lista_forms').DataTable({
  ajax: {
    url: 'includes/servico/get_servicos',
  },
  language: {
      "lengthMenu": " _MENU_ ",
      ...
      { 
          "targets": 1 ,
           ...
           "render": function (data, type, row, meta) {
						  ...
						  return '<a class="single_link" href="#servico-'+row.id+'" ><img style="width: 30px;border-radius: 50%;margin-right: 5px;max-height:30px;min-height:30px;" src="'+img+'" />'+row.short_dec+'</a>';
			  }	
      },
      { 
          "targets": 2 , 
...
function RemoveItem(productId,nome,imagem){
    ...
    information = '<div class="user-info">'+
                        ...
                        '<div class="detail">'+
                            ...
                            '<h5>Você deseja remover este Serviço ?</h5>'+
                        '</div>'+
                    '</div>';
    ...
    swal({
        ...
        preConfirm: function() {
          return new Promise(function(resolve) {
             ...
             $.ajax({
                   url: 'includes/servico/delete_servico',
                   type: 'POST',
                   dataType:"json",
                   data: {
                    id : productId
