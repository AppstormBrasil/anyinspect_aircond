...
<div class="container-fluid">
    ...
    <script>
        ...
        ajax: {
            url: 'includes/funcionario/get_client_pay',
        },
        language: {
        ...
        columnDefs: [ 
            { 
                ...
                "render": function (data, type, row, meta) {
                        ...
                        return '<a  href="#func-comissao-'+row.id+'-'+mes_atual+'  " class="single_link"><img style="width: 30px;border-radius: 50%;margin-right: 5px;max-height:30px;min-height:30px;" src="'+img+'" />'+row.funcionario+'</a>';
                    }		
            },
            { 
                "targets": 1 , 
