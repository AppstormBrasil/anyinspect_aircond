                        ...
                        <div class="col-lg-12">
                            <a href="calendario">
                                <div class="card widget-music-category">
                                    <div class="card-body" style="background: linear-gradient(135deg,#18998d 0%,#18998d 100%);padding: 1.5rem;border-radius: 4px;">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row mt-4 align-items-center">
                                    <div class="col-3"><span class="text-muted">Treinamentos</span>
                                        <h2 class="" style="color:#E53935;">1</h2>
                                    </div>
                                    ...
                                    <div class="col-3"><span class="text-muted">Material</span>
                                        <h2 class="">0</h2>
                                    </div>
     ...
     data:{id:idCliente},
	  ...
	  if(status == "SUCCESS") {
        ...
        for(var a = 0; a < lista_atividades.length; a++){
            ...
            var desc_service = desc_service.substring(0, 25)+'...';
            ...
            if(id_ativo == 0 || id_ativo == null || id_ativo == 'null'){
                ...
                td_ativo =  '<td><a  href="ativo-'+id_ativo+'"><img class="avatar_table" src="'+foto_ativo+'" /> <span class="text-pale-sky">'+ativo+'</a> </span></td>';
            } */
          
            lista_bolt += '<tr>'+
                '<td><a href="detalhe-grupo-'+id_group+'">#'+id_group+'</a></td>'+
                '<td><a href="atividade-'+id+'-'+id_form+'" >'+desc_service+'</a></td>'+
                '<td><a  href="cliente-'+id_client+'"><img class="avatar_table" src="'+foto_cliente+'" /> <span class="text-pale-sky">'+nome_cliente+'</a> </span></td> '+
