    ...
    margin-top: 0px;
        ...
        <div class="container-fluid" >
            ...
            <div id="relatorio" class="post-content" style="background:white;padding:10px;margin:auto;margin-bottom: 20px;width: 1280px;">
                ...
                <h4><strong class="title_form">CONTROLE DE FERRAMENTAS AERONÁUTICAS</strong></h4>
                <br>
                ...
                <table border="1" cellspacing="0" cellpadding="0" class="responsive" style=" margin-bottom:80px; height:auto;width:100%">
                    <tr>
                        ...
                        <td valign="top" width="5%"><strong>BASE</strong></td>
                        <td valign="top" width="33%"><strong>LOCALIZAÇÃO</strong></td>
                        <td valign="top" width="2%"><strong>PATRIMÔNIO</strong></td>
                        <td valign="top" width="2%"><strong>CALIBRAÇÃO</strong></td>
            ...
            <!-- #/ container -->
            <?php include('includes/common/filter-tools.php'); ?>
...
<script>
    ...
    var lista_tipo = new Array('Calibrável','Ferramenta','Ferramental'); 
    ...
    get_relatorio_ferramenta(lista_base,days,lista_tipo);
...
function get_relatorio_ferramenta(lista_base,days,lista_tipo){
    $('#table_results').html('');
    $.ajax({
    url:"includes/ferramenta/get_relatorio_ferramenta",
    method:"GET",
    dataType: 'JSON',
    data:{
        days:days,
        ...
        var ferramentas = response.ferramentas;
        ...
        $('.base_list').html(text_val);
            if(ferramentas){
            check_result = "";
            ferramentas.forEach(function(el){
                
                check_result += '<tr style="height:15px;">'+
                '<td valign="top" width="5%">'+el.i+'</td>'+
                '<td valign="top" width="50%">'+el.descricao+'</td>'+
                '<td valign="top" width="10%">'+el.base+'</td>'+
                '<td valign="top" width="10%">'+el.descricao_local+'</td>'+
                '<td valign="top" width="10%">'+el.patrimonio+'</td>'+
                '<td valign="top" width="10%">'+el.calibracao+'</td>'+
