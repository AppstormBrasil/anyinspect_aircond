...
input[type=radio]:disabled:checked+label::after {
    background-color: rgba(0, 0, 0, .26)!important;
            ...
            <div  class="responsive" style="width:100%;min-height:800px;margin-bottom:20px;text-align:center;">
                    
                            <div valign="top" style="margin-top: 100px" class="logo_empresa_cover"></div>
                            <div style="margin-top: 300px;">
                                <h1>Plano de Manutenção de Operação e Controle</h1>
                            </div>
                            <div style="margin-top: 420px;">
                                <h1>Seguindo Orinetanção de:</h1>
                                <div class="responsive" style="margin-bottom:400px;">
                                    <ul>
                                        <li>
                                            <td valign="top" width="30%" class="">Lei 13.589 de 2018d</td>
                                        </li>
                                        <li>
                                            <td valign="top" width="30%" class="">Portaria 3.523/98 do Ministério da Saúde</td>
                                        </li>
                                        <li>
                                            <td valign="top" width="30%" class="">Data: <?=$current_date?></td>
                                        </li>
                ...
                <h5><strong>2- RELAÇÃO DOS AMBIENTES CLIMATIZADOS</strong></h5>
...
function get_info_gerais(){
    ...
    data:{
        ...
        $(".logo_empresa").html('<img  style="width:140px;height:70px;" class="avatar_logo" src="'+foto_empresa+'" alt="">');
        $(".logo_empresa_cover").html('<img  style="width:250px;height:100px;" class="avatar_logo" src="'+foto_empresa+'" alt="">');
                   ...
                   /* if (find_id.indexOf('js-signature') > -1){
                    ...
                    if(c_type == 'signature_box' || c_label == 'Assinaturas'){
                        ...
                        '<tr style="display:none;" id="'+id_atividade+'-box_text_comment_'+uniqueID+'-'+j+'" >'+
                            '<td colspan="5" valign="top"><strong>Observações:</strong><div id="text_comment_'+id_atividade+'_'+uniqueID+'-'+j+'"></div></td>'+
                        '</tr>'+
...
function call_evidences(id_atividade) {
    $.ajax({
        url:  "includes/atividade/get_evi_result_relatorio",
        type : 'GET',
        dataType: 'JSON',
        data :{
            ...
            if(status == 'SUCCESS'){
                ...
                if(comments != null){
                    ...
                    for(var a = 0; a < comments.length; a++){
                        ...
                        console.log(comments_target);
                        console.log(the_cooments);
