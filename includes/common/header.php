                    ...
                    <ul>
                        ...
                        <li class="icons">
                            <a href="javascript:void(0)" class="log-user">
                                <img src="images/nouser.png" alt=""> <span>No User</span>  <i class="fa fa-caret-down f-s-14" aria-hidden="true"></i>
                            </a>
                            <div class="drop-down dropdown-profile animated bounceInDown">
                                <div class="dropdown-content-body">
                                    <ul>
                                        <!--<li><a href="javascript:void()"><i class="icon-user"></i> <span>Perfil</span></a>
                                        </li>
                                        <li><a href="javascript:void()"><i class="icon-wallet"></i> <span>My Wallet</span></a>
                                        </li>
                                        <li><a href="javascript:void()"><i class="icon-envelope"></i> <span>Mensagem</span></a>
                                        </li>
                                       ...
                                       <li><a href="javascript:void()"><i class="icon-lock"></i> <span>Lock Screen</span></a>
                                        ...
                                        <!--<li><a class="logout_global single_link" href="javascript:void()"><i class="icon-power"></i> <span>Sair</span></a>-->
                                        <li><a class="logout_global single_link" href="login"><i class="icon-power"></i> <span>Sair</span></a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
