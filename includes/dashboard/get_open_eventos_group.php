...
(SELECT COUNT(b.id_group) From tb_booking WHERE b.status NOT IN('Deletado','Concluído')  GROUP BY b.id_group ) as total_groups
FROM tb_booking b 
...
WHERE b.status NOT IN('Deletado','Concluído','Cancelado')  GROUP BY b.id_group ORDER BY b.start_date" ); 
