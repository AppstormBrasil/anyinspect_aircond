...
pc.name as nome_cliente ,pc.nome_empresa ,  tcba.description as category , ps.id as id_form
FROM tb_booking b 
...
WHERE DATE(b.start_date) = CURDATE() AND b.status NOT IN('Deletado','Concluído')  GROUP BY b.id ORDER BY b.start_date" ); 
$db->execute();
