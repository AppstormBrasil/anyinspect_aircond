...
tca.id as id_ativo , tca.descricao as ativo , tca.foto as foto_ativo , tca.qrcode ,  bd.price_taxi , bd.pet_taxi , 
...
WHERE b.status NOT IN('Deletado','Concluído')  AND  b.id_group = :id_grupo ORDER BY b.start_date" ); 
