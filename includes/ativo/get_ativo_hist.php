...
DATE_FORMAT(pb.start_date,'%d/%m/%Y %H:%i:%s' ) as inicio_service , TIME_TO_SEC(TIMEDIFF(pbd.ended_at,pbd.started_at)) as total_gasto , ta.iata as aeroporto , pbd.id_booking 
FROM tb_booking pb
