...
$database->query("INSERT INTO tb_subcontrato (name, cpf, phone,phone2,email,rg,zip,street,number,neighbor, complemento, city, state_,obs,data_cadastro,lat,lon,cnpj,nome_empresa) VALUES (:nome, :cpf, :telefone1, :telefone2, :email, :rg, :cep, :endereco, :numero, :bairro, :complemento, :cidade, :estado, :obs, :current_date,:lat,:lon,:cnpj,:nome_empresa)");
