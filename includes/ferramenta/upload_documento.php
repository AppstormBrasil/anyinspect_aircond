...
$path = '../../images/upload/ferramentas/'.$id.'/';
$link = 'https://dnataoffice.anyinspect.com.br/images/upload/ferramentas/'.$id.'/'.$nome_arquivo;
        ...
        exit(0);
				...
				if(move_uploaded_file($f["tmp_name"], $path.$nome_arquivo) == false) {
				  ...
				  exit(0);
					...
					$database = new db();
					$database->query("INSERT INTO tb_tool_doc(id_tooling, description, link, date_register)VALUES (:id_tooling, :description, :link, :date_register)"); 
					$database->bind(':id_tooling', $id);
