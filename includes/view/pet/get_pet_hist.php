...
$db->query("SELECT ps.id as id_servico, ps.short_dec ,  pb.status , pb.id_client , pc.name as nome_cliente  , pc.foto as foto_cliente , pcp.id as id_pet , pcp.name as nome_pet , pcp.foto as foto_pet ,  pbd.started_at , pbd.ended_at , pbd.service_name , pbd.price , pbd.info_extra , pbd.pet_taxi
FROM pet_booking pb
