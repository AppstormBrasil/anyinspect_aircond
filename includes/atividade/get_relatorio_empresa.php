...
//$IdFormularioResposta = $_POST['IdFormulario'];
...
WHERE DATE(b.start_date) LIKE '%$the_date%' AND b.status <> 'Deletado' AND b.id_client = :id_client GROUP BY b.id ORDER BY b.start_date" ); 
