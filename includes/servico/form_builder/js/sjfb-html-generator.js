                ...
                if (v['choices']) {
                    ...
                    $.each( v['choices'], function( k, v ) {
                        ...
                        if (fieldType == 'select') {
                            ...
                            //console.log($currentField.find('label').text(v['label']));

                            var selected = v['sel'] ? ' checked' : '';
                            var choiceHTML = '<label class="control control--radio"><input type="radio" name="radio-' + name_radio + '"' + selected + ' value="' + v['label'] + '"><div class="control__indicator"></div><span>' + v['label'] + '</span></label>';
                            $currentField.find(".choices").append(choiceHTML);
                        }
