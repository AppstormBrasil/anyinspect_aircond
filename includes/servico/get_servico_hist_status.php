...
pb.forma_pagamento , pb.status_pagamento , tca.id as id_ativo , tca.descricao , tca.foto as foto_ativo , pbd.price_taxi , pbd.pet_taxi 
FROM tb_booking pb
...
WHERE pb.status_pagamento <> 'Sim' AND  pb.status <> 'Deletado' "); 
