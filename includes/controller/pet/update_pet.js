...
function update_pet_id(id){
	var nome_pet = $("#nome_pet_"+id).val();
	var sexo_pet = $("#sexo_pet_"+id).val();
	var raca_pet = $("#raca_pet_"+id).val();
	var porte_pet = $("#porte_pet_"+id).val();
	var hair_pet = $("#hair_pet_"+id).val();
	var mood_pet = $("#mood_pet_"+id).val();
	var obs_pet = $("#obs_pet_"+id).val();
	var dt_nasc_pet = $("#dt_nasc_pet_"+id).val();
