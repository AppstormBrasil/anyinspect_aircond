...
$database->query("INSERT INTO tb_clients_pet (id_client, name, breed, gender, mood, size, hair, dt_nasc, obs, data_cadastro) VALUES (:id_client, :nome_pet, :breed, :gender, :mood, :size, :hair, :dt_nasc_pet, :obs, :current_date)");
