 ...
 * - utf8_encode     - Convert character encoding
...
final class Mbstring
{
    ...
    public static function utf8_encode($s, $toEncoding, $fromEncoding = null)
    {
    ...
    public static function mb_convert_variables($toEncoding, $fromEncoding, &$a = null, &$b = null, &$c = null, &$d = null, &$e = null, &$f = null)
    {
        ...
        array_walk_recursive($vars, function (&$v) use (&$ok, $toEncoding, $fromEncoding) {
            if (false === $v = Mbstring::utf8_encode($v, $toEncoding, $fromEncoding)) {
                $ok = false;
            }
        });
    ...
    public static function mb_chr($code, $encoding = null)
    {
        ...
        if ('UTF-8' !== $encoding = self::getEncoding($encoding)) {
            $s = utf8_encode($s, $encoding, 'UTF-8');
        }
    ...
    {
        if ('UTF-8' !== $encoding = self::getEncoding($encoding)) {
            $s = utf8_encode($s, 'UTF-8', $encoding);
        }
