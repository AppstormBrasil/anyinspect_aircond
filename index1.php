        ...
        <div class="content-body">
            <div class="container-fluid">
                ...
                <!--<div class="col-xl-6 col-xxl-6 col-sm-6">
                    <div class="card">
                        <div class="card-body stat-widget-seven gradient-8">
                            <div class="media align-items-center ml-3">
                                <img class="mr-5" src="assets/images/icons/24-black.png" alt="">
                                <div class="media-body">
                                <a href="agendamento" ><h2 class="mt-0 mb-2">Agendar</h2></a>
                                    <h5 class="text-uppercase">Registrar novo agendamento</h5>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            <div class="card-body stat-widget-seven gradient-m2">
                                <div class="media align-items-center ml-3">
                                    ...
                                    <div class="media-body">
                                    <a href="calendario" ><h2 class="mt-0 mb-2">Calendário</h2></a>
                                        <h5 class="text-uppercase">Gerenciar meus agendamentos</h5>
                                    </div>
                                </div>
                            </div>
                        </div>
					...
					<div class="col-lg-3 col-6 col-xxl-3">
						<a href="calendario">
							<div class="card widget-music-category">
								<div class="card-body">
									<h2 class="text-light mb-4" id="servicos_hoje">0</h2>
					...
					<div class="col-lg-3 col-6 col-xxl-3">
						<a href="calendario">
							<div class="card widget-music-category">
								<div class="card-body">
									<h2 class="text-light mb-4" id="servicos_pendentes">0</h2>
									<h4>Pendentes</h4>
								</div>
							</div>
						</a>
					...
					<div class="col-lg-3 col-6 col-xxl-3">
						<a href="calendario">
							<div class="card widget-music-category">
								<div class="card-body">
									<h2 class="text-light mb-4" id="servicos_finalizados">0</h2>
									<h4>Concluídos</h4>
								</div>
							</div>
						</a>
					...
					<div class="col-lg-3 col-6 col-xxl-3">
						<a href="calendario">
							<div class="card widget-music-category">
								<div class="card-body">
									<h2 class="text-light mb-4" id="servicos_em_andamento">0</h2>
									<h4>Andamento</h4>
								</div>
							</div>
						</a>
							...
							<div class="col-xl-3 col-sm-6">
								<div class="card stat-widget-six">
									<div class="card-body">
										<div class="media">
											<div class="media-body">
												<a href="status-pagamentos"><h4 href="status-pagamentos" class="mt-0 mb-1">Status Pagamento</h4></a>
												</div>
											<a href="status-pagamentos" >
												<div class="icon bg-primary">
     ...
     data:{id:idCliente},
	  ...
	  if(status == "SUCCESS") {
		for(var a = 0; a < lista_pet.length; a++){
			...
			ativo = lista_pet[a].ativo;
			preco = lista_pet[a].preco;
			desc_service = lista_pet[a].desc_service;
			br_start = lista_pet[a].br_start;
            status_ = lista_pet[a].status_;
            foto = lista_pet[a].foto;
            id_ativo = lista_pet[a].id_ativo;
            foto_ativo = lista_pet[a].foto_ativo;
            id = lista_pet[a].id;
            textColor = lista_pet[a].textColor;
            color = lista_pet[a].color;
            ...
            func_list = lista_pet[a].func_list;
            pet_taxi = lista_pet[a].pet_taxi;
            if(pet_taxi == 1){
                pet_taxi = 'Sim';
            } else {
                pet_taxi = 'Não'
