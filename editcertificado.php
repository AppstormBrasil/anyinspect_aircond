    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card forms-card">
                <div class="card-body">
                    <h4 class="no-print card-title">Editar Certificado</h4>
                    <div class="basic-form">
                        <button id="edit_certifica" type="buttom" class="no-print btn btn-light">Editar</button>
                        <!--<button id="print" type="buttom" class="no-print btn btn-light">Imprimir</button>-->
                        <form id="form-cliente" action="javascript:EdditarCertificado();" method="post" style="width:100%;">
                            ...
                            <?php include('includes/common/right-sidebar-designacao.php'); ?>
...
get_information()
 function get_information(){
    ...
    $.ajax({
      url:  "includes/certificados/get_certificado",
      type: 'GET',
      dataType:"json",
      ...
      success:function(response)
      {
        ...
        $(".logo_empresa").html('<img  style="width:60%;height:50px;" class="avatar_logo" src="'+foto_empresa+'" alt="">');
