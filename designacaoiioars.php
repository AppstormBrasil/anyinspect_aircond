...
<input type="hidden" value="<?=$id?>" id="id_user" />
        <div class="container-fluid" >
            ...
            <div id="relatorio" class="post-content" style="background:white;padding:10px;margin:auto;margin-bottom: 20px;width: 1280px;">
                ...
                <h4><strong>Inspetor de Controle da Qualidade.</strong></h4>
                <p style="margin-top: 30px;">Como <strong>Inspetor de Controle da Qualidade </strong> o mencionado funcionário está autorizado para realizar as seguintes funções:</p>
                ...
                <table cellspacing="1" cellpadding="0" class="responsive" style="width:100%;margin-top:40px;margin-bottom:80px;">
                    <tbody>
                        <tr>
                            <td valign="top">a) Aprovar o retorno a serviço (ARS) após cheques tipo "Transit Check", 24 hours check (Daily Check), 07 Dias Check, e "A checks" em aeronaves B737.</td>
                        </tr>
                        <tr>
                            <td valign="top">b) Aprovar o retorno a serviço (ARS) após inspeções consideradas fora de fase em aeronaves B737.</td>
                        </tr>
                        <tr>
                            <td valign="top">c) Aprovar o retorno a serviço (ARS) após inspeções de AD´s, DA´s, SB´s, e SL´s , relacionadas com suas especialidades (CEL) e (GMP) em aeronaves B737.</td>
                        </tr>
                        <tr>
                            <td valign="top">d) Aprovar o retorno a serviço (ARS) após pequenos reparos estruturais de acordo com o SRM em aeronaves B737.</td>
                        </tr>
                        <tr>
                            <td valign="top">e) Aprovar o retorno a serviço (ARS) após verificação de items de inspeção obrigatorias (I.I.O.) em aeronaves B737.</td>
                        </tr>
                        <tr>
                            <td valign="top">f) Aprovar o retorno a serviço (ARS) após verificação de items de operações PBN, relacionadas com sua especiabilidade (CEL) e (GMP) em aeronaves B737.</td>
                        </tr>
                        <tr>
                            <td valign="top">g) Aprovar o retorno a serviço (ARS) após verificação de items de operações RVSM, relacionadas com sua especiabilidade (CEL) e (GMP) em aeronaves B737.</td>
                        </tr>
                        <tr>
                            <td valign="top">h) Aprovar o retorno a serviço (ARS) após teste de Run Up em aeronaves B737.</td>
                        </tr>
                        <tr>
                            <td valign="top">i) Realizar Inspeção de Recebimento de Materiais.</td>
                        </tr>
