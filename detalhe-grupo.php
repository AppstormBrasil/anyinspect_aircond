...
<div class="container-fluid">
    ...
    <?php $id = $_GET['id']; ?>
            ...
            <div class="card" style="min-height: 183px;">
                <div class="card-body">
                    <div class="border-bottom-1 pb-3 d-sm-flex justify-content-between align-items-center">
                        <div class="bg-white">
                            <h3 class="group_id">#</h3>
                        </div>
                        <div class="avatar-group my-3 my-sm-0">
                            <h3 class="data_atividade"></h3>
                        </div>
                    </div>
                    <div class="row mt-4 align-items-center">
                        <div class="col-9"><span class="text-muted">Empresa</span>
                            <h3 class="endereco_empresa"></h3>
                        </div>
                        <div class="col-3">
                            <a  class="single_link" style="cursor:pointer;" href="#rel-atv-<?php echo $id ?>" ><span style="background:#efefef;color:#111;width: 100%;" class="label label ">Relatório</span></a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-lg-6">
            <div class="card">
                <div class="card-body">
                    <div class="border-bottom-1 pb-3 d-sm-flex justify-content-between align-items-center">
                        <div class="bg-white">
                            <h3 class="" style="float:left;">Acompanhamento</h3>
                        </div>
                    </div>
                    <div class="row mt-4 align-items-center">
        ...
        <div class="card">
            <div class="card-header pb-4">
                <h4 class="card-title mt-2"> Atividades</h4>
	...
	<script src="includes/dashboard/dash_grupo.js"></script>
...
function open_map(map_txt,map_only){
	...
	$.ajax({
     url:"includes/dashboard/get_evento_grupo",
     method:"GET",
     dataType:'JSON',
     data:{id_grupo:id_grupo},
	  ...
	  if(status == "SUCCESS") {
        ...
        for(var a = 0; a < lista_atividades.length; a++){
            ...
            qrcode = lista_atividades[a].qrcode;
            ...
            if(id_ativo == 0 || id_ativo == null || id_ativo == 'null'){
                ...
                td_ativo =  '<td><a  class="single_link"  href="#ativo-'+id_ativo+'"><img class="avatar_table" src="'+foto_ativo+'" /> <span class="text-pale-sky">'+ativo+'</a> </span></td>';
            } 
            ...
            '</tr>';
              ...
              $('.group_id').html('#'+id_group);
              $('.endereco_empresa').html(nome_cliente);
              $('.data_atividade').html(br_start);
              /*setTimeout(function(){
                    ...
                    data:{id:id},
                        success:function(response){
                            ...
                            if(id_ativo == 0 || id_ativo == null || id_ativo == 'null'){
                                ...
                                box_ativo = '<a  class="single_link" target="_blank" href="#ativo-'+id_ativo+'"><span  ><img class="avatar_table" src="'+foto_ativo+'" alt="Avatar" height="30" width="30"></a><span><strong>'+descricao+'</strong></span> </span>'
                            }
                            ...
                            event_content = `<div class="profile-personal-info">
                                            ...
                                            <span><a  class="single_link" href="#atividade-`+id+`-`+id_form+`" ><h2 style="margin-bottom: 45px;">Atividade: `+title+`</h2></a></span>
                                            ...
                                            <div class="row mb-4">
                                                ...
                                                <div class="col-8" id="name_client_edit" ><a  class="single_link" target="_blank" href="#cliente-`+id_client+`"><span><img class="avatar_table" src="`+foto_cliente+`" alt="Avatar" height="30" width="30"></a><span style="margin-right: 10px;">` +name_client+`</span></span>
                                                </div>
                                            </div>
                                            <div class="row mb-4">
                                                <div class="col-4">
    ...
    $('.edit_pet').on('click', function(e){ 
        ...
        $('#pet_cliente_edit').select2({
            ...
            $('.update_event').on('click', function(e){ 
                ...
                var valor_interface = '<a  class="single_link" target="_blank" href="#ativo-'+valor_campo+'"><span><img class="avatar_table" src="'+foto+'" alt="Avatar" height="30" width="30"></a><span>'+name+'</span>';
    ...
    $('.edit_client').on('click', function(e){ 
        ...
        $('.update_event').on('click', function(e){ 
            ...
            var valor_interface_client = '<a  class="single_link" target="_blank" href="#cliente-'+valor_campo+'"><span><img class="avatar_table" src="'+foto_client+'" alt="Avatar" height="30" width="30"></a><span>'+name_client+'</span>';
        ...
        $('#lista_funcionario_filtro_edit').select2({
            ...
            $('.update_event').on('click', function(e){ 
                ...
                for(let i = 0; i < choose_pet.length; i = i + 1 ) {
                    valor_interface += '<a class="single_link" target="_blank" href="#ativo-'+choose_pet[i].id+'"><span><img class="avatar_table" src="'+choose_pet[i].foto+'" alt="Avatar" height="30" width="30"></a><span>'+choose_pet[i].name+'</span>';
    ...
    $('.edit_servico').on('click', function(e){ 
        ...
        function servicesearch(data) {
            ...
            if (data.id == 'none') {
                return 'Nenhuma Atividade atribuída <a target="_blank" style="float: right;" class="single_link btn btn-primary btn-sm" href="#funcionario-'+id_team +'" >Atribuir Atividade</a>';
            } else {
