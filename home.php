...
.table td, .table th {
    ...
    border-top: 1px solid #dee2e6;
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                        <div class="col-lg-12">
                            <a class="single_link" href="calendario">
                                <div class="card widget-music-category">
                                    <div class="card-body" style="background:#18998d;padding: 1.5rem;border-radius: 4px;">
                                    <div class="media align-items-center text-center">
                                        <img class="mr-3" width="70" src="assets/images/icons/24.png" alt="">
                                        
                                            <div class="media-body">
                                                <a href="javascript:toogle_element(`new_atividade`)"><h2 class="mt-0 mb-2 text-white" >Nova Atividade</h2></a>
                                                <a href="javascript:toogle_element(`new_atividade`)"><h5 class=" text-white">Click aqui para criar uma nova Atividades</h5></a>
                                            </div>
                        ...
                        <div class="col-lg-12" id="new_atividade" style="display:none;">
                            <div class="card forms-card">
                                <div class="card-body">
                                    <h4 class="card-title">Escolha o Profissional  <a href="javascript:toogle_element(`new_atividade`)" style="cursor:pointer;" ><span style="background:#E91E63;color:#fff;float: right;" class="label label ">Fechar</span></a></h4>
                                    ...
                                    <div class="basic-form">
                                        <div class="card-box">
                                            ...
                                            <div style="width: 100%;" class="row" id="list_funcionarios"></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="row mt-4 align-items-center">
                                    <div class="col-3"><span class="text-muted f-s-12">Pendentes</span>
                                        <h2 class="text-primary" id="servicos_pendentes">0</h2>
                                    </div>
                                    <div class="col-3"><span class="text-muted f-s-12">Finalizados</span>
                                        <h2 class="text-primary compl_act" >0</h2>
                                    </div>
                                    <div class="col-3" id="atrasados"><span class="text-muted f-s-12 ">Atrasadas</span>
                                        <h2 class="text-muted">0</h2>
                                    </div>
                                    <div class="col-lg-3" id="percent_act">
                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            <div class="card-body">
                                <div class="border-bottom-1 pb-3 d-sm-flex justify-content-between align-items-center">
                                    <div class="bg-white">
                                        <h3 class="">Vencimentos</h3>
                                    </div>
                                </div>
                                <div class="row mt-4 align-items-center">
                                    <div class="col-3"><span class="text-muted">Treinamentos</span>
                                        <h2 id="treinamentos_expira">0</h2>
                                    </div>
                                    <div class="col-3"><span class="text-muted">Ferramentas</span>
                                        <h2 id="ferramentas_expira">0</h2>
                                    </div>
                                    <div class="col-3"><span class="text-muted">Task</span>
                                        <h2 class="">0</h2>
                                    </div>
                                    <div class="col-3"><span class="text-muted">Consumível</span>
                                        <h2 class="">0</h2>
                                    </div>
                    ...
                    <div class="card">
                        <div class="card-header pb-4">
                            ...
                            <a class="text-dark" href="javascript:toogle_element(`new_map`)" >
                                <span style="float:right;font-size:20px;"><i class="mdi mdi-google-maps"></i></span>
                            </a>
                        </div>
                        <div class="card-body p-2">
                        
                        
                        <div class="col-lg-12" id="new_map" style="display:block;">
                            <div class="row" id="my_map_dash" style="height: 400px"></div>
                        </div>  
                        ...
                        <div class="col-12" style="float: left;">
                                <div class="event-sideber-search">
                                    <form action="#" method="post" class="chat-search-form">
                                        <input id="search_eventos" type="search" class="form-control" placeholder="Procurar">
                                        <i class="fa fa-search"></i>
                                    </form>
                                </div>
                            </div>
                            <div class="table-responsive">
                                <table id="table_acti" class="table recent-order-list-table table-responsive-fix-big">
                                    <thead>
                                        <tr style="background: #18998d;">
                                            <th>#</th>
                                            <th>Atividade</th>
                                            <th>Cliente</th>
                                            <th>Atividade</th>
                        ...
                        <br>    
                        <div class="card-header pb-4">
                            <h4 class="card-title mt-2"> Atividades não finalizadas</h4>
        ...
        <div id="calendarModal" class="modal fade">
            <div class="modal-dialog" >
                <div class="modal-content">
                    ...
                    <h2 style="color: #111;">Detalhes da Atividade <h2 style="margin-left: 10px;"id="num_atividade"></h2> </h2> <button type="button" class="close" data-dismiss="modal" style="color: #111;opacity: 1;">×</button>
                    </div>
    ...
    <?php include('includes/modal/nova-agenda-dash-air.php'); ?>
...
/*window.onhashchange = function() {
	...
	$.ajax({
     url:"includes/dashboard/get_open_eventos_group",
     method:"GET",
     dataType:'JSON',
     data:{id:idCliente},
        ...
        var not_close_list = response.open;
        
        var lista_atividade , lista_atividadess , per = "";
        var status_type = "";

	    if(status == "SUCCESS") {
	      
	      if(lista_atividades == 'undefined' || lista_atividades == undefined){
	          $('#opens_box').html('Nehuma Atividade Encontrada para Hoje');
	      } else {
                ...
                foto_cliente = lista_atividades[a].foto_cliente;
                ...
                nome_cliente = lista_atividades[a].nome_cliente;
                id_client = lista_atividades[a].id_client;
                id_form = lista_atividades[a].id_form;
                id_group = lista_atividades[a].id_group;
                total_groups = lista_atividades[a].total_groups;
                if(desc_service == null || desc_service == 'null'){
                    desc_service = 'N/A';
                } else {
                    desc_service = desc_service.substring(0, 25)+'...';
                   
                }
    
                lista_atividade += '<tr>'+
                    '<td><a class="single_link" href="detalhe-grupo-'+id_group+'">#'+id_group+'</a></td>'+
                    '<td><a class="single_link" href="atividade-'+id+'-'+id_form+'" >'+desc_service+'</a></td>'+
                    '<td><a class="single_link" href="cliente-'+id_client+'"><img class="avatar_table" src="'+foto_cliente+'" /> <span class="text-pale-sky">'+nome_cliente+'</a> </span></td> '+
                    '<td><b>('+total_groups+')</b> Atividades</td>'+
                    '<td>'+br_start+'</td>'+
                    '<td>'+func_list+'</a> '+
                    '<td><a style="cursor:pointer;" class="start_servico" name="'+id+'" ><span style="background:'+color+';color:'+textColor+'" class="label label ">'+status_+'</a></span>'+
                    '</td>'
                '</tr>';
    
    			}
                  $('#opens_box').html(lista_atividade);
       }
	      
	      if(not_close_list == 'undefined' || not_close_list == undefined){
	          $('#opens_box_').html('Nehuma Atividade Encontrada');
	      } else {
	            for(var a = 0; a < not_close_list.length; a++){
    			client_id = not_close_list[a].client_id;
    			client_name = not_close_list[a].client_name;
    			client_pic = not_close_list[a].client_pic;
    			ativo = not_close_list[a].ativo;
    			preco = not_close_list[a].preco;
    			desc_service = not_close_list[a].desc_service;
    			br_start = not_close_list[a].br_start;
                status_ = not_close_list[a].status_;
                foto = not_close_list[a].foto;
                id_ativo = not_close_list[a].id_ativo;
                foto_ativo = not_close_list[a].foto_ativo;
                id = not_close_list[a].id;
                textColor = not_close_list[a].textColor;
                color = not_close_list[a].color;
                foto_funcionario = not_close_list[a].foto_funcionario;
                foto_cliente = not_close_list[a].foto_cliente;
                id_funcionario = not_close_list[a].id_funcionario;
                nome_funcionario = not_close_list[a].nome_funcionario;
                foto_ativo = foto_ativo +'?' + (new Date()).getTime();
                foto_funcionario = foto_funcionario +'?' + (new Date()).getTime();
                foto_cliente = foto_cliente +'?' + (new Date()).getTime();
                func_list = not_close_list[a].func_list;
                nome_cliente = not_close_list[a].nome_cliente;
                id_client = not_close_list[a].id_client;
                id_form = not_close_list[a].id_form;
                id_group = not_close_list[a].id_group;
                total_groups = not_close_list[a].total_groups;
                if(desc_service == null || desc_service == 'null'){
                    desc_service = 'N/A';
                } else {
                    desc_service = desc_service.substring(0, 25)+'...';
                ...
                '</tr>';
                  ...
                  $('#opens_box_').html(lista_atividade);
       }
            ...
            var that = this, $allListElements = $('#opens_box tr ');
            ...
            $matchingListElements.show();
              ...
              $(".start_servico").click(function(){
                id = this.name;
                $.ajax({
                    url:"includes/dashboard/get_eventos_single",
                    method:"POST",
                    dataType:'JSON',
                    data:{id:id},
                        success:function(response){
                            ...
                            var id, id_client , start , end , status_, title , box_ativo
                            ...
                            endereco_cliente = event.endereco_cliente;
                            endereco = event.endereco;
                            foto_cliente = event.foto_cliente;
                            var box_ativo = "";
                            if(id_ativo == 0 || id_ativo == null || id_ativo == 'null'){
                                box_ativo = 'N/A'
                            } else {
                                box_ativo = '<a target="_blank" href="ativo-'+id_ativo+'"><span  ><img class="avatar_table" src="'+foto_ativo+'" alt="Avatar" height="30" width="30"></a><span><strong>'+descricao+'</strong></span> </span>'
                            }
                            ...
                            if(status_ == "Pendente"){
                                ...
                                $('#finalizar').show();
                                $('#comecar').hide();
                                cancel_btn = '<button style="font-size: 11px;padding: 2px 5px 3px 5px;margin-left: 10px;background: #F44336;color: #fff;border-color: #F44336;" type="submit" class="btn btn-danger calncelserico" id="calncelserico" >Cancelar Atividade</button>';
                                $('#concluido').hide();
                                $('#reprovar').hide();
                            
                            }
                            else if(status_ == "Cancelado"){
                                cancel_btn = '<button style="font-size: 11px;padding: 2px 5px 3px 5px;margin-left: 10px;background: #F44336;color: #fff;" class="btn " >Cancelado</button><button style="font-size: 11px;padding: 2px 5px 3px 5px;margin-left: 10px;background: #222222;color: #fff;border-color: #222222;" type="submit" class="btn btn-danger delete_service" id="delete_service" >Deletar Atividade</button>';
                                $('#comecar').hide();
                                $('#finalizar').hide();
                                $('#concluido').hide();
                                $('#reprovar').hide();
                            ...
                            event_content = `<div class="profile-personal-info">
                                            ...
                                            <span><a href="atividade-`+id+`-`+id_form+`" ><h2 style="margin-bottom: 45px;">Atividade: `+title+`</h2></a></span>
                                            ...
                                            <div class="row mb-4">
                                                ...
                                                <div class="col-8" id="name_ativo_edit">
                                                `+box_ativo+`
                                                </div>
                                            </div>    
                                            ...
                                            <div class="row mb-4">
                                                <div class="col-4">
                                                    <h5 class="f-w-500"><strong>Atividade</strong> `+edit_servico+`<span class="pull-right">:</span></h5>
                                                </div>
                                            ...
                                            <div class="row mb-4">
                                                ...
                                                <div class="col-8"><span id="pet_endereco_edit" >`+endereco_cliente+`</span>
                                                </div>
                                            </div>
                                            <div class="row mb-4">
                                                <div class="col-4">
    ...
    $('.edit_pet').on('click', function(e){ 
        ...
        $('#pet_cliente_edit').select2({
			ajax: {
				url: 'includes/dashboard/get_ativos_from_client?id_cliente='+id_client+'',
				type : 'POST',
				dataType : 'JSON',
				delay: 600,
            ...
            $('.update_event').on('click', function(e){ 
                ...
                var campo = 'id_pet';
                var valor_campo = id;
                var interface = 'name_ativo_edit';
                var valor_interface = '<a target="_blank" href="ativo-'+valor_campo+'"><span><img class="avatar_table" src="'+foto+'" alt="Avatar" height="30" width="30"></a><span>'+name+'</span>';
    ...
    $('.edit_client').on('click', function(e){ 
        ...
        $('#cliente_edit').on('select2:select', function (e) {
                ...
                $('#pet_cliente_edit option:selected').remove();
                $("#pet_cliente_edit").val('').trigger('change');
        ...
        $('.update_event').on('click', function(e){ 
            ...
            var valor_interface_client = '<a target="_blank" href="cliente-'+valor_campo+'"><span><img class="avatar_table" src="'+foto_client+'" alt="Avatar" height="30" width="30"></a><span>'+name_client+'</span>';
            ...
            if(id_client != ''){
                ...
                information = '<div class="user-info">'+
                        ...
                        swal({
                            ...
                            preConfirm: function() {
                                $.ajax({
                                    url: 'includes/dashboard/editar_evento',
                                    type: "POST",
                                    dataType: 'JSON',
                                    data: {
                                        id_event:id_event,
        ...
        $('#lista_funcionario_filtro_edit').select2({
            ...
            $('.update_event').on('click', function(e){ 
                ...
                for(let i = 0; i < choose_pet.length; i = i + 1 ) {
                    valor_interface += '<a target="_blank" href="ativo-'+choose_pet[i].id+'"><span><img class="avatar_table" src="'+choose_pet[i].foto+'" alt="Avatar" height="30" width="30"></a><span>'+choose_pet[i].name+'</span>';
    ...
    $('.edit_servico').on('click', function(e){ 
        ...
        var my_change = 
            '<div class="modal-header" >'+
                    '<h2>Alterar Atividade </h2> <button type="button" class="close" data-dismiss="modal" >×</button>'+
            '</div>'+
            '<div id="modalBodyTime" class="modal-body">'+
                '<div class="form-group">'+
        ...
        function servicesearch(data) {
            ...
            if (data.id == 'none') {
                return 'Nenhuma Atividade atribuída <a target="_blank" style="float: right;" class="btn btn-primary btn-sm" href="funcionario-'+id_team +'" >Atribuir Atividade</a>';
            } else {
            ...
            $('.update_event').on('click', function(e){ 
                ...
                if(choose_pet.length == 0 ){
                    toastr.error('Ops!Escolha a Atividade', 'Error');  
                    return;
                }
                let id_event = $('#id_edit').val();
    ...
    $('.edit_valor').on('click', function(e){ 
        ...
        var my_change = 
            ...
            '<div id="modalBodyTime" class="modal-body">'+
                '<div class="form-group">'+
                    '<label class="text-label">Valor Atividade</label>'+
                    '<div class="input-group">'+
        ...
        $('#valor_edit').mask('000.000.000.000.000,00', {reverse: true});
            $('.update_event').on('click', function(e){ 
                ...
                if(valor_edit == '' ){
                    toastr.error('Ops!Digite o valor da Atividade', 'Error');  
                    return;
                }
   ...
   function doDelete(){  
    ...
    information = '<div class="user-info">'+
                     '<div class="detail">'+
                         '<h4><strong>Confirmação</strong></h4>'+
                         '<h5>Você deseja realmente deletar esta Atividade?</h5>'+
                     '</div>'+
                 '</div>';
                           ...
                           data: {
                            ...
                            repprove_message:repprove_message
                                ...
                                success: function(response) {
                                    ...
                                    toastr.success("Atividade finalizada com sucesso!", 'Sucesso');
                                    $('#calendarModal').modal('hide');
                                 }
                           });
...
function doCancel(){  
    ...
    information = '<div class="user-info">'+
                     '<div class="detail">'+
                         '<h4><strong>Confirmação</strong></h4>'+
                         '<h5>Você deseja realmente cancelar esta Atividade?</h5>'+
                     '</div>'+
                 '</div>';
			...
			if(acao == "concluido"){
				...
				information = '<div class="user-info">'+
                        ...
                        '<div class="detail">'+
							...
							'<h5>A Atividade foi finalizada! Deseja enviar uma mensagem no whatsapp do cliente?</h5>'+
                ...
                toastr.success("Atividade iniciada com sucesso!", 'Sucesso');
                $('#calendarModal').modal('hide');
				setTimeout(function(){ 
                    get_open_service();
                    get_valores();
...
function alteraHorario(id , br_start_hora, termina_hora, start_dateReage, id_funcionario){
   ...
   function formatpetresult(data) {
		...
		if(data.loading){
			...
			var markuppet = '<span><img style="height:30px;width:30px;border-radius:25px;" src="'+data.foto+'" class="flag" />'+ data.name +'</span>';
		}
		return markuppet;
	}
    ...
    function edit_event(id_event,campo,valor_campo,interface,valor_interface,database){
        ...
        information = '<div class="user-info">'+
                        '<div class="detail">'+
                            '<h4><strong>Confirmação</strong></h4>'+
                            '<h5>Você deseja realmente editar este ítem ?</h5>'+
                        '</div>'+
                    '</div>';
