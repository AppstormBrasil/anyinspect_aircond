        ...
        <div class="col-xl-12" >
            <div class="card ttransparent-card m-b-0">
                <div class="card-header" style="background: white;padding:15px;">
                    <h4 class="card-title">Lista de Ferramentas</h4>
                    <a class="btn btn-primary btn-xs single_link" href="#relatorioferramenta" type="button"><span>Relatório</span></a>
                </div>
...
var table = $('#lista_ferramentas').DataTable({
  ajax: {
    url: 'includes/ferramenta/get_ativos',
  },
  language: {
      "lengthMenu": " _MENU_ ",
    ...
    swal({
        ...
        preConfirm: function() {
          return new Promise(function(resolve) {
             ...
             $.ajax({
                   url: 'includes/ferramenta/delete_ativo',
                   type: 'POST',
                   dataType:"json",
                   data: {
                    id : productId
