...
tca.id as id_ativo , tca.descricao as ativo , tca.foto as foto_ativo , bd.price_taxi , bd.pet_taxi , pc.nome_empresa ,
...
if($result){
	foreach($result as $row) {
		...
		if ($foto_cliente != ""){
			...
			$foto_cliente = prod_path."images/no_image.jpg" ;
		}
		...
		if ($foto_ativo != ""){
			...
			$foto_ativo = prod_path."images/no_image.jpg" ;
		}
