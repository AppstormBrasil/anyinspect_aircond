<?php 
 ...
 function get_total_gasto($data_ini,$data_fim){
    ...
    $db->query("SELECT 			
                ...
                LEFT JOIN tb_clients_pet pcp ON pcp.id = pbd.id_pet 
 ...
 function get_month_compare(){
	 ...
	 $db->query("SELECT 			
            ...
            LEFT JOIN tb_book_detail pbd ON pbd.id_booking = pb.id 
            LEFT JOIN tb_client pc ON pb.id_client = pc.id 
            LEFT JOIN tb_clients_pet pcp ON pcp.id_client = pc.id 
            LEFT JOIN tb_services ps ON ps.id = pbd.service_name 
            LEFT JOIN tb_service_prod tsp ON tsp.id_service = ps.id
            LEFT JOIN tb_product tp ON tp.id = tsp.id_product
            WHERE pb.start_date >= '$data_ini' AND pb.start_date <= '$data_fim'             
    ...
    $response['produto_total_prev'] = $prodprev;
        ...
        function get_tb_visits($data_ini,$data_fim){
            $db = new db();
         ...
         $tb_visits =  get_tb_visits($data_ini,$data_fim);
